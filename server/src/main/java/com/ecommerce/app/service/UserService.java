...
//import com.ecommerce.app.api.security.service.EncryptionService;
//import com.ecommerce.app.api.security.service.JWTService;
...
//    }
//
//    public void registerUser(RegistrationBody registrationBody) throws DuplicateUser, NotMatchingPasswords {
...
//        AppUser appUser = appUserDAO.findByUsernameIgnoreCase(username).orElseThrow(() -> new UsernameNotFoundException(String.format("Username %s not found", username)));
//
//        return SecureAppUser.fromAppUser(appUser);
//    }
//}
